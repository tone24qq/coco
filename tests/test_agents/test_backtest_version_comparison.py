...
def test_backtest_version_comparison_contains_v3_baselines() -> None:
    ...
    assert "v3_baseline" in out and "v3_current" in out
    assert "delta_top3" in out["deltas"]


def test_backtest_version_comparison_requires_historical_v3() -> None:
    ...
    assert out["reason"] == "missing historical v3_core20 reference"
