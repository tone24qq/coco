...
def main() -> None:
    ...
    modes = ["weighted_only", "vote_only", "weighted_plus_vote", "weighted_plus_vote_with_gate"]
    results = {}
    ...
    report = {
        ...
        "conclusion": {
            "voting_more_stable_than_weighted": results["vote_only"]["mrr"] >= results["weighted_only"]["mrr"],
            "voting_better_as_bonus": results["weighted_plus_vote_with_gate"]["mrr"] >= results["vote_only"]["mrr"],
        },
    }
