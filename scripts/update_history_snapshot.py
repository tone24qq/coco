...
from src.io.canonical_dataset import (
    CANONICAL_CSV,
    CANONICAL_PARQUET,
...
def _persist_canonical(df: pd.DataFrame) -> None:
...
def main() -> None:
    ...
    canonical = load_canonical_or_build().sort_values("issue").reset_index(drop=True)
