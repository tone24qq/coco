...
pytest -q tests/test_agents/test_phase6_runtime_history.py -k "processed_history_exists or processed_shards_exist or no_compact_or_processed or deploy_and_local_consistent or auto_build_processed_history_from_raw or manual_recent_payload_fail_fast"
