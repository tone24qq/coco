...
from src.predict import _abs_path, _normalize_predict_config_paths, _resolve_runtime_artifact_dir, run_prediction
...
def get_runtime() -> tuple[ModelArtifacts | None, dict[str, Any], str | None]:
    config_path = _abs_path("configs/predict.yaml")
